...
@section('content')
    ...
    <div class="rounded-lg  pt-5  bg-white p-4 shadow-md">
        ...
        <form action="" method="" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" class="block w-full" value="{{ old('title') }}" required />
                {{-- <input messages="$errors->get('title')" class="mt-2" /> --}}
            </div>

            <div class="mt-4">
                <label for="message" :value="__('Message')" ></label>
                <textarea id="message"
                        name="message"
            ...
            <div class="mt-4">
                <label for="labels" :value="__('Labels')"></label>
                    ...
                    @endforeach
                {{-- <error :messages="$errors->get('labels')" class="mt-2" /> --}}
            </div>

            <div class="mt-4">
                <label for="categories" :value="__('Categories')" ></label>
            ...
            <div class="mt-4">
                <label for="priority" :value="__('Priority')" ></label>
                ...
                {{-- <error :messages="$errors->get('priority')" class="mt-2" /> --}}
            </div>

            {{-- @hasanyrole('admin|agent')
                <div class="mt-4">
                    <label for="assigned_to" :value="__('Assign to')" ></label>
                    <select name="assigned_to" id="assigned_to" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus-within:text-primary-600 focus:border-primary-300 focus:ring-primary-200 focus:ring focus:ring-opacity-50">
                     ...
                     <error :messages="$errors->get('assigned_to')" class="mt-2" />
                </div>
            @endhasanyrole --}}
